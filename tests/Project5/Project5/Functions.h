...
bool selection() {
    ...
    std::cout << "3. Convert Balanced Tree to BST.\n";
    std::cout << "4. Print Binary Balanced Tree.\n";
    std::cout << "5. Print Binary Search Tree.\n";
    std::cout << "6. Add element into the Balanced Tree.\n";
    std::cout << "7. Add element into the BST.\n";
    std::cout << "0. Exit.\n";
    std::cout << ">";
    int choice;
    (std::cin >> choice).get();
